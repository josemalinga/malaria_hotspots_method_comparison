...
type_hotspot = c("single", "multiple","decay", "river", "short", "long", "mid", "lag")
...
write.csv(results3,"results_si.csv", row.names = T)
 
}

#to calcutate the confidence intervals
results3 <- read.csv(paste0(getwd(),"/results_si.csv"), header = T)
